                    ...
                    <div className="hero">
                        <div className="hero-text-box">
                            ...
                            <p className="hero-description">
                                Find remote jobs that fit your skills and
                                lifestyle. Connect with global companies, grow
                                your career, and unlock new opportunities from
                                anywhere.
                            </p>
                            ...
                            <p className="statistic">
                                More than <strong>7,500</strong> professionals
                                have joined Remote Work Hub, collaborating,
                                sharing knowledge, and building projects
                                together
                            </p>
                        </div>
            ...
            <section className="section-features">
                ...
                <div className="feature-box">
                    ...
                    <div className="feature-description">
                        <div className="feature-title">
                            ...
                            <h3 className="heading-thernary">
                                Seamless Communication
                            </h3>
                        </div>

                        <p className="feature-description">
                            Connect with your team instantly using built-in chat
                            and messaging tools. Keep every conversation
                            organized in one central hub and avoid the chaos of
                            scattered emails or endless meetings. Share ideas,
                            provide feedback, and stay aligned with your team —
                            whether you’re across the office or across the
                            world. With real-time updates and smart
                            notifications, you’ll never miss an important
                            detail.
                        </p>
                ...
                <div className="feature-box">
                    <div className="feature-description">
                        ...
                        <p className="feature-description">
                            ...
                            around the world. Access listings in multiple
                            industries and time zones, filter by your skills and
                            preferences, and apply directly to positions that
                            match your career goals. Stay competitive and
                ...
                <div className="feature-box">
                    ...
                    <div className="feature-description">
                        ...
                        <p className="feature-description">
                            Continuously improve your skills and advance your
                            career with curated resources, webinars, and
                            professional development opportunities. Connect with
                            mentors, join workshops, and receive guidance that
                            helps you excel in the remote work environment.
                            Build your expertise and stay ahead in a competitive
                            global market.
                        </p>
                        <button className="btn-learnMore">Learn more</button>
                    </div>
                ...
                <div className="testimonial-container">
                    <div className="testimonial-box">
                        ...
                        <p className="customer-message">
                            ...
                            with global companies. I was able to find projects
                            that perfectly matched my skills, and the platform’s
                            communication tools made collaborating across time
                            zones seamless and efficient."
                        </p>
                    ...
                    <div className="testimonial-box">
                        ...
                        <p className="customer-message">
                            "Thanks to Remote Work Hub, I was able to land my
                            first international data science project within
                            weeks. The platform made it easy to showcase my
                            skills and collaborate with clients remotely, which
                            boosted my career significantly."
                        </p>
                        <p className="customer-name">
                    ...
                    <div className="testimonial-box">
                        ...
                        <p className="customer-message">
                            ...
                            teaching opportunities. I can now connect with
                            students worldwide effortlessly, manage my schedule,
                            and focus on delivering quality lessons without
                            worrying about logistics."
                        </p>
                        <p className="customer-name">
                            John Smith : Online Teacher
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="pricing-plan pricing-plan--starter">
                        <header className="plan-header">
                            ...
                            <p className="plan-txt">
                                per month. That's hus $13 per job!
                            </p>
                        </header>
                        <ul class="list">
                            <li class="list-item">
                        ...
                        <div className="plan-sing-up">
                            <a
                                href="#"
                                class="pricing-btn no-decoration btn-sign-up"
                            >
                                Start getting now
                            </a>
                        </div>
                    ...
                    <div className="cta-left">
                        <div className="cta-description">
                            ...
                            <p className="cta-desc">
                                Find the right e-visa trip, easy apply in
                                minutes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="cta-right">
                        <div className="right-left">
                            <label htmlFor="email" className="cta-label">
                                <HiOutlineMail className="cta-icon" /> Your
                                Email
                            </label>
                            <input
                                id="email"
