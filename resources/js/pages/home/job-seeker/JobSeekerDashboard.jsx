  ...
  return (
    <div className="dashboardContainer">
      ...
      <div className="messageBox">
        <h1 className="welcomeMessage">Welcome back, Mohammad 👋</h1>
      ...
      <div className="activeBox">
        ...
        <div className="rightSide">
          ...
          <div className="teamActivity">
            ...
            <ul>
              <li>
                <span className="avatar">M</span> You applied for “Frontend
                Engineer”
              </li>
              <li>
                <span className="avatar">S</span> Sara saved a new job
              </li>
              <li>
                <span className="avatar">A</span> Ahmad completed project
                “Redesign”
              </li>
            </ul>
          </div>
